...
class PatternEncoder(nn.Module):
    def __init__(self, params):
        ...
        pre_proj = {}
        for name in params['input_dim'].keys():
            pre_proj[name] = nn.Linear(self.input_dim[name], self.hidden_dim)
        self.pre_projection = nn.ModuleDict(pre_proj)
    ...
    def encode_node(self, dataset, patterns, feat, node_pe, e_feat=None, params=None):
